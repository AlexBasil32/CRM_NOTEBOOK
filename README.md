...
Курс "Профессия "Фронтенд разработчик с нуля", образовательной платформы Skillbox.ru
...
Перед запуском убедитесь, что вы установили Node.js версии 12 или выше, так же убедитесь что у вас установлен live-server.
...
Далее зайдите в папку crm-frontend и нажмите на кнопку в правом нижнем углу "Go live" для запуска лайф-сервера
